<div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm page-break relative label-card group hover:shadow-lg hover:border-blue-300 transition-all duration-300" data-id="<?php echo $row['id']; ?>">
    <!-- Checkbox -->
