...
<body class="antialiased text-gray-800 bg-light overflow-x-hidden flex flex-col min-h-screen hero-gradient">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute top-1/2 -right-24 w-80 h-80 bg-accent/20 rounded-full blur-3xl animate-float"
    ...
    <nav id="navbar" class="fixed w-full z-50 transition-all duration-300 py-2 px-4 md:py-4 md:px-6">
        <div
            class="container mx-auto bg-white/90 backdrop-blur-md rounded-full shadow-lg border border-white/50 px-4 py-2 md:px-6 md:py-3 flex justify-between items-center">
            <a href="index.php" class="flex items-center gap-3 group">
                <div class="relative">
                    <div
                        class="absolute -inset-1 bg-gradient-to-r from-primary to-accent rounded-full blur opacity-75 group-hover:opacity-100 transition duration-200">
                    </div>
                    <img src="assets/images/logo01.JPG" alt="Logo"
                        class="relative h-8 w-8 md:h-10 md:w-10 rounded-full border-2 border-white object-cover">
                </div>
                <span
                    class="font-bold text-lg md:text-xl tracking-wide text-secondary group-hover:text-primary transition">PHICHAI
                    RUN <span class="text-primary">2026</span></span>
            </a>
    ...
    <main class="flex-grow flex items-center justify-center relative z-10 pt-24 md:pt-32 pb-20">
        <div class="container mx-auto px-4 max-w-3xl">
            ...
            <div class="glass-card rounded-3xl shadow-2xl overflow-hidden animate-fade-in-up visible">
                <div
                    class="bg-gradient-to-r from-yellow-500 to-yellow-600 p-6 md:p-8 text-center text-white relative overflow-hidden">
                    <div
                    ...
                    <p class="opacity-90 text-base md:text-lg relative z-10">เสื้อ Phichai Run 2026 ราคาตัวละ 250 บาท
                    </p>
                </div>

                <form id="shirtOrderForm" action="order_shirt.php" method="POST" enctype="multipart/form-data"
                    class="p-5 md:p-10">
                    <!-- Security Tokens -->
                    ...
                    <div class="mb-10">
                        <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden shadow-inner">
                            <div id="progressBar"
                                class="h-full bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full transition-all duration-500 ease-out"
                                style="width:33%"></div>
                        </div>
                    ...
                    <div class="form-step" data-step="1">
                        <h3
                            class="text-xl font-bold text-secondary border-b border-gray-200 pb-3 mb-6 flex items-center gap-2">
                            <i class="fas fa-user-circle text-yellow-500"></i> ข้อมูลผู้สั่งซื้อ
                        </h3>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label class="block text-gray-700 font-bold mb-2 text-sm">คำนำหน้า <span
                                        class="text-red-500">*</span></label>
                                <select name="prefix" id="prefix_select" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500 transition bg-gray-50 focus:bg-white">
                                ...
                                <input type="text" name="prefix_custom" id="prefix_custom"
                                    class="hidden mt-2 w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500 transition bg-gray-50 focus:bg-white"
                                    placeholder="กรอกคำนำหน้า...">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-gray-700 font-bold mb-2 text-sm">ชื่อ-นามสกุล <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-gray-700 font-bold mb-2 text-sm">เบอร์โทรศัพท์ <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-gray-700 font-bold mb-2 text-sm">อีเมล <span
                                        class="text-gray-400 font-normal">(ไม่บังคับ)</span></label>
                        ...
                        <div class="mt-6">
                            <label class="block text-gray-700 font-bold mb-2 text-sm">ที่อยู่จัดส่ง <span
                                    class="text-red-500">*</span></label>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                ...
                                <input type="text" name="subdistrict" id="subdistrict"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500 transition bg-gray-50 focus:bg-white"
                                    placeholder="ตำบล">
                                <input type="text" name="district_province" id="district_province"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500 transition bg-gray-50 focus:bg-white"
                                    placeholder="อำเภอ / จังหวัด">
                            </div>
                            <p id="postal_help" class="text-xs text-yellow-600 mt-1 mb-3"></p>
                            <textarea name="address_detail" rows="2" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500 transition bg-gray-50 focus:bg-white"
                        ...
                        <div class="mt-8 flex justify-end">
                            <button type="button"
                                class="next-btn w-full md:w-auto bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-yellow-500/30 transition transform hover:-translate-y-1">
                    ...
                    <div class="form-step hidden" data-step="2">
                        ...
                        <!-- Size Chart -->
                        <div class="mb-8">
                            <img src="assets/images/shirt02.JPG" alt="ตารางไซส์เสื้อ"
                                class="w-full max-w-2xl mx-auto rounded-2xl shadow-lg border border-gray-100">
                        </div>

                        <div class="mb-6">
                            <h4 class="text-sm font-bold text-gray-500 mb-3 uppercase tracking-wider">Standard Sizes
                                (ผู้ใหญ่)</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
                                <!-- XS -->
                                <div
                                    class="flex items-center justify-between bg-white border border-gray-200 rounded-xl p-3 hover:border-yellow-400 transition">
                                    <span class="font-bold text-gray-700">XS</span>
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('XS', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="XS"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('XS', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                    </div>
                                </div>
                                <!-- S -->
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('S', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('M', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="M"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('M', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('L', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="L"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('L', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('XL', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="XL"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('XL', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('2XL', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="2XL"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('2XL', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('3XL', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="3XL"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('3XL', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('4XL', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="4XL"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('4XL', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('5XL', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="5XL"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('5XL', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                            ...
                            <h4 class="text-sm font-bold text-gray-500 mb-3 uppercase tracking-wider">Kids Sizes (เด็ก)
                            </h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('KS', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="KS"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('KS', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('KM', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="KM"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('KM', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('KL', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="KL"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('KL', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('KXL', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="KXL"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('KXL', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="adjustQty('K2XL', -1)"
                                            class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold">-</button>
                                        <input type="number" min="0" value="0" data-size="K2XL"
                                            class="shirt-qty-input w-12 text-center border border-gray-300 rounded-lg py-1 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                                            readonly>
                                        <button type="button" onclick="adjustQty('K2XL', 1)"
                                            class="w-8 h-8 rounded-full bg-yellow-100 hover:bg-yellow-200 flex items-center justify-center text-yellow-700 font-bold">+</button>
                        ...
                        <div class="mt-8 border-t border-gray-200 pt-6">
                            <label class="block text-gray-700 font-bold mb-4 text-sm">ประเภทคอเสื้อ <span
                                    class="text-red-500">*</span></label>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <label class="relative cursor-pointer">
                                    <input type="radio" name="collar_type" value="round" class="peer hidden" checked>
                                    <div
                                        class="p-4 border-2 border-gray-200 rounded-xl peer-checked:border-yellow-500 peer-checked:bg-yellow-50 transition">
                        ...
                        <div class="mt-6 bg-yellow-50 rounded-xl p-4 border border-yellow-200">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-2xl font-bold text-yellow-600"><span id="total-amount">0</span> บาท
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 flex flex-col-reverse md:flex-row justify-between gap-4 md:gap-0">
                            <button type="button"
                                class="prev-btn w-full md:w-auto bg-gray-100 text-gray-600 hover:bg-gray-200 font-bold py-3 px-8 rounded-full transition">
                    ...
                    <div class="form-step hidden" data-step="3">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                            ...
                            <div>
                                ...
                                <div
                                    class="bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl p-5 md:p-6 text-white shadow-lg relative overflow-hidden group transform transition hover:scale-[1.02]">
                                    <div
                                        class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full">
                                    </div>
                                    <div
                                        class="absolute bottom-0 left-0 -mb-4 -ml-4 w-20 h-20 bg-white opacity-10 rounded-full">
                                    </div>
                                    ...
                                    <div class="flex justify-between items-start mb-6 relative z-10">
                                        ...
                                        <span
                                            class="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-lg text-xs font-medium">ออมทรัพย์</span>
                                    </div>

                                    <div class="mb-6 relative z-10">
                                        <p class="text-blue-100 text-xs mb-1">เลขที่บัญชี Account No.</p>
                                        <div class="flex items-center gap-3">
                                            <span class="font-mono text-2xl md:text-3xl font-bold tracking-widest"
                                                id="acc-no">517-0-12428-7</span>
                                            <button type="button" onclick="copyToClipboard('5170124287', this)"
                                                class="text-white/70 hover:text-white transition p-2 rounded-full hover:bg-white/10"
                                                title="คัดลอก">
                                    ...
                                    <div class="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                                        ...
                                        <div class="border-t border-gray-200 mt-4 pt-4">
                                            <div class="flex justify-between items-center">
                                                ...
                                                <span class="font-bold text-2xl text-yellow-600"><span
                                                        id="payment-amount">0</span> บาท</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-8">
                                <label class="block text-gray-700 font-bold mb-3 text-sm">หลักฐานการโอนเงิน (สลิป) <span
                                        class="text-red-500">*</span></label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    <div>
                                        <label class="block text-gray-600 font-medium mb-2 text-sm">วันที่โอน <span
                                                class="text-red-500">*</span></label>
                                        <input type="date" name="payment_date" id="payment_date" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500 transition bg-gray-50 focus:bg-white">
                                    </div>
                                    <div>
                                        <label class="block text-gray-600 font-medium mb-2 text-sm">เวลาที่โอน <span
                                                class="text-red-500">*</span></label>
                                ...
                                <div id="upload-area"
                                    class="relative border-2 border-dashed border-gray-300 rounded-2xl p-6 md:p-8 text-center hover:bg-yellow-50 hover:border-yellow-300 transition group cursor-pointer bg-gray-50">
                                    <input type="file" name="payment_slip" id="payment_slip" accept="image/*"
                                        class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required>
                                    <i
                                        class="fas fa-cloud-upload-alt text-4xl md:text-5xl text-gray-300 group-hover:text-yellow-400 transition mb-4"></i>
                                    <p class="text-gray-500 group-hover:text-gray-700 transition">
                                ...
                                <div id="slip-preview-container" class="hidden mt-6">
                                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                        <div class="flex items-start gap-4">
                                            <img id="slip-preview-img" src="" alt="Preview"
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <button type="button" id="remove-slip-btn"
                                                    class="mt-2 text-red-500 hover:text-red-600 text-sm font-bold">
                            ...
                            <div class="mt-8 flex flex-col-reverse md:flex-row justify-between gap-4 md:gap-0">
                                ...
                                <button type="submit"
                                    class="w-full md:w-auto bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-yellow-500/30 transition transform hover:-translate-y-1">
    ...
    <nav
        ...
        <div class="flex justify-around items-center py-2">
            <!-- หน้าหลัก -->
            <a href="index.php"
                class="flex flex-col items-center gap-1 px-3 py-2 text-gray-500 hover:text-primary transition-colors">
            ...
            <!-- ติดต่อ -->
            <a href="https://www.facebook.com/phichairun2026/" target="_blank"
                class="flex flex-col items-center gap-1 px-3 py-2 text-gray-500 hover:text-primary transition-colors">
    ...
    <div class="hidden md:flex fixed right-6 bottom-6 flex-col gap-3 z-50">
        <!-- หน้าหลัก -->
        <a href="index.php"
            class="group relative w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-primary hover:shadow-xl hover:scale-110 transition-all duration-300 border border-gray-100">
            <i class="fas fa-home text-lg"></i>
            <span
                class="absolute right-full mr-3 px-3 py-1.5 bg-gray-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">หน้าหลัก</span>
        </a>
        <!-- เช็คสถานะ -->
        <a href="check_status.php"
            class="group relative w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-green-500 hover:shadow-xl hover:scale-110 transition-all duration-300 border border-gray-100">
            <i class="fas fa-search text-lg"></i>
            <span
                class="absolute right-full mr-3 px-3 py-1.5 bg-gray-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">เช็คสถานะ</span>
        </a>
        <!-- สมัครวิ่ง -->
        <a href="register.php"
            class="group relative w-12 h-12 bg-gradient-to-r from-primary to-red-600 rounded-full shadow-lg flex items-center justify-center text-white hover:shadow-xl hover:scale-110 transition-all duration-300">
            <i class="fas fa-running text-lg"></i>
            <span
                class="absolute right-full mr-3 px-3 py-1.5 bg-gray-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">สมัครวิ่ง</span>
        </a>
    </div>
